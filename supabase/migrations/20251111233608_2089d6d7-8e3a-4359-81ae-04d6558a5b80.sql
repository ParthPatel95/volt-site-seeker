-- Drop the old retraining history table if it exists
DROP TABLE IF EXISTS public.aeso_retraining_history CASCADE;

-- Create new retraining history table with correct schema
CREATE TABLE public.aeso_retraining_history (
