    ...
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
      ...
      <main className="pt-16 relative z-10">
        ...
        <div id="track-1" className="border-t-4 border-purple-500">
          <div className="bg-purple-500/10 py-4"><div className="container mx-auto px-4"><h2 className="text-2xl font-bold text-foreground">Track 1: Foundation & Site Development</h2><p className="text-muted-foreground">Power infrastructure, energy markets, and site selection fundamentals</p></div></div>
        ...
        <div id="track-2" className="border-t-4 border-orange-500">
          <div className="bg-orange-500/10 py-4"><div className="container mx-auto px-4"><h2 className="text-2xl font-bold text-foreground">Track 2: Due Diligence & Risk Assessment</h2><p className="text-muted-foreground">Comprehensive risk evaluation and site scoring frameworks</p></div></div>
        ...
        <div id="track-3" className="border-t-4 border-blue-500">
          <div className="bg-blue-500/10 py-4"><div className="container mx-auto px-4"><h2 className="text-2xl font-bold text-foreground">Track 3: Project Execution & Operations</h2><p className="text-muted-foreground">Development timelines, insurance, and crisis management</p></div></div>
        ...
        <div id="track-4" className="border-t-4 border-green-500">
          <div className="bg-green-500/10 py-4"><div className="container mx-auto px-4"><h2 className="text-2xl font-bold text-foreground">Track 4: Scaling Your Operation</h2><p className="text-muted-foreground">Capacity planning, multi-site strategy, and portfolio management</p></div></div>
        ...
        <div id="track-5" className="border-t-4 border-pink-500">
          <div className="bg-pink-500/10 py-4"><div className="container mx-auto px-4"><h2 className="text-2xl font-bold text-foreground">Track 5: Capital & Strategic Growth</h2><p className="text-muted-foreground">Fundraising, partnerships, M&A, and exit strategies</p></div></div>
        ...
        <div id="frameworks" className="border-t-4 border-indigo-500">
          <div className="bg-indigo-500/10 py-4"><div className="container mx-auto px-4"><h2 className="text-2xl font-bold text-foreground">Strategic Analysis Frameworks</h2><p className="text-muted-foreground">Academic tools for strategic decision-making</p></div></div>
          <Suspense fallback={<SectionLoader />}><AcademicEnhancementsSection variant="strategic-frameworks" /></Suspense>
          <SectionDivider color="cyan" />
          <Suspense fallback={<SectionLoader />}><AcademicEnhancementsSection variant="quantitative-tools" /></Suspense>
        </div>

        <SectionDivider color="yellow" />

        <div id="glossary" className="border-t-4 border-teal-500">
          <div className="bg-teal-500/10 py-4"><div className="container mx-auto px-4"><h2 className="text-2xl font-bold text-foreground">Mining Glossary</h2><p className="text-muted-foreground">Comprehensive terminology reference</p></div></div>
          <section className="py-16 bg-muted/30"><div className="container mx-auto px-4 max-w-4xl"><Suspense fallback={<SectionLoader />}><Glossary /></Suspense></div></section>
        </div>
