...
import { Building2, Target, Search, FileText, Handshake, TrendingUp, AlertTriangle } from "lucide-react";
    ...
    <section id="mergers-acquisitions" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <ScrollReveal delay={100}>
          <h3 className="text-2xl font-bold text-watt-navy mb-6">M&A Strategies</h3>
          <div className="bg-white rounded-2xl shadow-lg border border-watt-navy/10 overflow-hidden mb-12">
            <div className="flex border-b border-watt-navy/10">
            ...
            <div className="p-8">
              <p className="text-watt-navy/70 mb-6">{maStrategies[selectedStrategy].description}</p>
              
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-watt-gray/50 rounded-xl p-4">
              ...
              <div className="mt-6 p-4 bg-watt-success/10 rounded-xl">
                <span className="text-sm font-medium text-watt-navy">Typical Valuation Method: </span>
                <span className="text-sm text-watt-navy/70">{maStrategies[selectedStrategy].valuation}</span>
              </div>
            </div>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal delay={200}>
          <h3 className="text-2xl font-bold text-watt-navy mb-6">Due Diligence Checklist</h3>
            ...
            {dueDiligenceAreas.map((area, index) => (
              ...
              >
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h4 className="font-semibold text-watt-navy">{area.area}</h4>
                </div>
                <ul className="space-y-2">
                  {area.items.map((item, i) => (
                    <li key={i} className="text-sm text-watt-navy/70 flex items-start gap-2">
                      <div className="w-4 h-4 border border-watt-navy/30 rounded mt-0.5 shrink-0"></div>
                      {item}
                    </li>
                  ))}
                </ul>
        ...
        <ScrollReveal delay={300}>
          <h3 className="text-2xl font-bold text-watt-navy mb-6">Post-Acquisition Integration</h3>
