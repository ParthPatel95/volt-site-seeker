      ...
      <div className="container mx-auto px-4">
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-watt-navy mb-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {scalingPillars.map((pillar, index) => (
              ...
              >
                ...
                <h3 className="text-lg font-semibold text-watt-navy mb-2">{pillar.title}</h3>
                <p className="text-watt-navy/70 text-sm">{pillar.description}</p>
              </div>
            ))}
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal delay={200}>
          <div className="bg-gradient-to-r from-watt-success/10 to-watt-blue/10 rounded-2xl p-8 md:p-12">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-3xl font-bold text-watt-navy mb-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-watt-navy">Lower per-MW operating costs</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-watt-success rounded-full"></div>
                    <span className="text-watt-navy">Better power rate negotiations</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-watt-success rounded-full"></div>
                    <span className="text-watt-navy">Bulk equipment discounts</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-watt-success rounded-full"></div>
                    <span className="text-watt-navy">Diversified risk profile</span>
                  </div>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white rounded-xl p-6 text-center shadow-md">
                  ...
                  <div className="text-sm text-watt-navy/70">Cost reduction at 100MW+</div>
                </div>
                <div className="bg-white rounded-xl p-6 text-center shadow-md">
                  <div className="text-3xl font-bold text-watt-bitcoin mb-2">2-3x</div>
                  <div className="text-sm text-watt-navy/70">Typical growth target</div>
                </div>
                <div className="bg-white rounded-xl p-6 text-center shadow-md">
                  <div className="text-3xl font-bold text-watt-blue mb-2">18-24</div>
                  <div className="text-sm text-watt-navy/70">Months expansion cycle</div>
                </div>
                <div className="bg-white rounded-xl p-6 text-center shadow-md">
                  <div className="text-3xl font-bold text-watt-navy mb-2">$500K+</div>
                  <div className="text-sm text-watt-navy/70">Per MW capital cost</div>
                </div>
              </div>
            </div>
          </div>
