          ...
          <div className="lg:sticky lg:top-24 lg:self-start">
            <Reveal y={28}>
              <div className="relative overflow-hidden rounded-3xl ring-1 ring-white/10">
                {/* Slightly oversize + parallax so the frame stays full while the
                    image drifts behind it. */}
                <Parallax speed={56} axis="y" className="aspect-[4/5] sm:aspect-[5/6] lg:aspect-[4/5]">
                  <img
                    src={substationImg}
