    ...
    <section className="relative z-10 py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
          ...
          <div className="bg-gradient-to-br from-slate-800/60 to-slate-900/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-slate-700/50 shadow-2xl hover:shadow-electric-blue/20 transition-all duration-500">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="bg-slate-800/40 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-slate-700/30 hover:border-electric-blue/30 transition-all duration-300">
                <div className="flex justify-between items-center">
                  <div className="flex items-center">
                    <div className="w-2.5 sm:w-3 h-2.5 sm:h-3 bg-slate-400 rounded-full mr-2 sm:mr-3"></div>
                    <span className="text-slate-300 text-base sm:text-lg font-medium">Industrial Land</span>
                  </div>
                  <span className="text-xl sm:text-2xl font-bold text-slate-400">$50k/acre</span>
                </div>
              </div>
              ...
              <div className="bg-slate-800/40 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-electric-blue/30 hover:border-electric-blue/50 transition-all duration-300">
                <div className="flex justify-between items-center">
                  <div className="flex items-center">
                    <div className="w-2.5 sm:w-3 h-2.5 sm:h-3 bg-electric-blue rounded-full mr-2 sm:mr-3"></div>
                    <span className="text-slate-300 text-base sm:text-lg font-medium">Power Infrastructure</span>
                  </div>
