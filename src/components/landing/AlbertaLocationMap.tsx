...
export const AlbertaLocationMap = () => {
  return (
    <section className="relative py-16 sm:py-20 md:py-24 bg-watt-navy">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4">
            Strategic <span className="text-watt-trust">Location</span>
          </h2>
          <p className="text-lg sm:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
            Positioned at the heart of North America's <span className="text-watt-success font-semibold">renewable energy corridor</span>
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6 lg:col-span-2">
            <h3 className="text-2xl font-bold text-white mb-6">
              Why <span className="text-watt-bitcoin">Alberta</span>?
            </h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {locationBenefits.map((benefit, index) => (
                <div 
                  key={index}
                  className="group bg-white/5 backdrop-blur-sm rounded-xl p-5 border border-white/10 hover:border-watt-trust/50 transition-all hover:-translate-y-1"
                >
                  <div className="flex items-start gap-4">
                    <div className="p-2 bg-watt-trust/10 rounded-lg group-hover:bg-watt-trust/20 transition-colors">
                      <benefit.icon className="w-5 h-5 text-watt-trust" />
                    </div>
                    <div>
