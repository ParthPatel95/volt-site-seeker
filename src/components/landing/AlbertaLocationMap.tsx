          ...
          <div className="space-y-6 lg:col-span-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              {locationBenefits.map((benefit, index) => (
                <div 
                  key={index}
                  className="group bg-card/50 backdrop-blur-sm rounded-xl p-5 border border-border/50 hover:border-electric-blue/50 transition-all hover:scale-102 hover:bg-card/70"
                >
