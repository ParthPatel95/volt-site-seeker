...
export const VoltScoutSection = () => {
  return (
    <section className="relative z-10 py-12 px-6 bg-watt-navy">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-10">
          <div className="flex items-center justify-center mb-6">
            ...
            <div className="text-left">
              ...
              <p className="text-lg text-white/70 text-left">AI-Powered Energy Discovery Platform</p>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
          <Card className="bg-white/5 border-white/10 hover:border-watt-trust/50 transition-all group hover:shadow-xl backdrop-blur-sm">
          ...
          <Card className="bg-white/5 border-white/10 hover:border-watt-bitcoin/50 transition-all group hover:shadow-xl backdrop-blur-sm">
            <CardHeader className="pb-4">
              <div className="flex items-center space-x-2 mb-3">
          ...
          <Card className="bg-white/5 border-white/10 hover:border-watt-success/50 transition-all group hover:shadow-xl backdrop-blur-sm">
            <CardHeader className="pb-4">
              <div className="flex items-center space-x-2 mb-3">
        ...
        <div className="bg-white/5 rounded-3xl p-6 border border-white/10 mb-8 backdrop-blur-sm">
          <div className="text-center mb-6">
            ...
            <p className="text-white/70">Real-time market intelligence powered by machine learning</p>
          </div>
