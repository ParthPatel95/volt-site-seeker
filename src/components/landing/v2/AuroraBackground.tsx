...
export function AuroraBackground() {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden bg-background" aria-hidden="true">
      ...
      {/* Aurora blobs */}
      <div
        className="absolute -top-40 -left-32 w-[44rem] h-[44rem] rounded-full blur-3xl opacity-25 motion-safe:animate-aurora-1 motion-reduce:animate-none"
        style={{ background: 'radial-gradient(circle, hsl(var(--primary) / 0.55), transparent 65%)' }}
      />
      <div
        className="absolute top-1/4 -right-48 w-[40rem] h-[40rem] rounded-full blur-3xl opacity-20 motion-safe:animate-aurora-2 motion-reduce:animate-none"
        style={{ background: 'radial-gradient(circle, hsl(var(--watt-trust) / 0.5), transparent 65%)' }}
      />
      <div
        className="absolute bottom-[-12rem] left-1/3 w-[36rem] h-[36rem] rounded-full blur-3xl opacity-15 motion-safe:animate-aurora-3 motion-reduce:animate-none"
        style={{ background: 'radial-gradient(circle, hsl(var(--watt-bitcoin) / 0.45), transparent 65%)' }}
      />
