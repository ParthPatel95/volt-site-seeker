    ...
    <section className="relative z-10 py-8 sm:py-10 md:py-12 px-4 sm:px-6 bg-slate-900/50">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-6 sm:mb-8 md:mb-10">
          ...
          <p className="text-slate-200 text-base sm:text-lg max-w-2xl mx-auto px-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
          <Card className="bg-slate-800/50 border-slate-700 hover:border-electric-blue/50 transition-all group">
            <CardHeader className="pb-2 sm:pb-3">
              ...
              <CardTitle className="text-white text-base sm:text-lg">Target Returns</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-1">
                <div className="text-xl sm:text-2xl font-bold text-electric-blue">2.0-2.5x</div>
                <div className="text-slate-300 text-xs sm:text-sm">MOIC</div>
                <div className="text-lg sm:text-xl font-bold text-electric-yellow">30-40%</div>
          ...
          <Card className="bg-slate-800/50 border-slate-700 hover:border-neon-green/50 transition-all group">
            <CardHeader className="pb-2 sm:pb-3">
              ...
              <CardTitle className="text-white text-base sm:text-lg">Current Pipeline</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-1">
                <div className="text-xl sm:text-2xl font-bold text-neon-green">700MW+</div>
                <div className="text-slate-300 text-xs sm:text-sm">Power Capacity</div>
                <div className="text-lg sm:text-xl font-bold text-electric-blue">1,000+</div>
                <div className="text-slate-300 text-xs sm:text-sm">Acres</div>
              </div>
            </CardContent>
          </Card>
          
          <Card className="bg-slate-800/50 border-slate-700 hover:border-warm-orange/50 transition-all group sm:col-span-2 md:col-span-1">
            <CardHeader className="pb-2 sm:pb-3">
              ...
              <CardTitle className="text-white text-base sm:text-lg">Exit Strategy</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-1">
                <div className="text-xl sm:text-2xl font-bold text-electric-yellow">~2 Year</div>
                <div className="text-slate-300 text-xs sm:text-sm">Hold Period</div>
                <div className="text-base sm:text-lg font-semibold text-warm-orange">Data Center Premium</div>
