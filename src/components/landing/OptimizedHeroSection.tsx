...
import { Datacenter3DScene } from './Datacenter3DScene';
import './landing-animations.css';

export const OptimizedHeroSection = () => {
  return (
    <section className="relative z-10 pt-24 sm:pt-32 md:pt-36 pb-20 sm:pb-24 md:pb-28 px-4 sm:px-6 overflow-hidden bg-gradient-to-b from-white to-watt-light">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-[55%] text-center lg:text-left">
            ...
            <ScrollReveal delay={100}>
              <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-7xl xl:text-8xl font-bold mb-6 sm:mb-8 leading-tight text-watt-navy tracking-tight">
                Building Digital<br />
            ...
            <ScrollReveal delay={300}>
              <div className="flex flex-col sm:flex-row items-center lg:items-start lg:justify-start justify-center gap-8 sm:gap-12 mb-12 sm:mb-14">
          ...
          <div className="w-full lg:w-[45%] h-[400px] lg:h-[500px]">
            <ScrollReveal delay={200}>
              <Datacenter3DScene />
            </ScrollReveal>
          </div>
