      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 mb-12">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-gradient-to-br from-slate-800/90 to-slate-900/95 backdrop-blur-xl rounded-3xl p-8 md:p-10 border border-red-500/20 shadow-2xl group-hover:shadow-red-500/20 transition-all duration-500 group-hover:scale-[1.02]">
              {/* Header */}
              <div className="flex items-center mb-8">
                <div className="relative">
                  <div className="w-14 h-14 bg-gradient-to-br from-red-500 to-orange-500 rounded-2xl flex items-center justify-center mr-4">
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={index} className="group/item flex items-start space-x-4 p-4 rounded-xl hover:bg-red-500/5 transition-all duration-300 hover:translate-x-2">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-gradient-to-br from-slate-800/90 to-slate-900/95 backdrop-blur-xl rounded-3xl p-8 md:p-10 border border-neon-green/30 shadow-2xl group-hover:shadow-neon-green/20 transition-all duration-500 group-hover:scale-[1.02]">
              {/* Header */}
              <div className="flex items-center mb-8">
                <div className="relative">
                  <div className="w-14 h-14 bg-gradient-to-br from-neon-green to-electric-blue rounded-2xl flex items-center justify-center mr-4">
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={index} className="group/item flex items-start space-x-4 p-4 rounded-xl hover:bg-neon-green/5 transition-all duration-300 hover:translate-x-2">
