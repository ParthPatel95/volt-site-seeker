...
export const BTCMiningROIWidget = () => {
  ...
  return (
    <Card className="bg-card backdrop-blur-sm border border-border hover:border-watt-success/30 transition-all duration-300 group shadow-institutional">
      <CardHeader className="pb-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <CardTitle className="text-foreground text-xl">BTC Mining ROI Lab</CardTitle>
          </div>
          <div className="flex items-center space-x-2">
        ...
        <p className="text-muted-foreground text-sm">Calculate mining profitability with real-time data</p>
      </CardHeader>
      <CardContent className="space-y-6">
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-muted rounded-lg p-4 transition-all duration-500 border border-border hover:border-watt-trust/30">
          ...
          <div className="bg-muted rounded-lg p-4 transition-all duration-500 border border-border hover:border-watt-bitcoin/30">
            <div className="flex items-center space-x-2 mb-2">
          ...
          <div className="bg-muted rounded-lg p-4 transition-all duration-500 border border-border hover:border-watt-success/30">
            <div className="flex items-center space-x-2 mb-2">
          ...
          <div className="bg-muted rounded-lg p-4 transition-all duration-500 border border-border hover:border-watt-warning/30">
            <div className="flex items-center space-x-2 mb-2">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <h4 className="text-sm font-semibold text-foreground">Your Mining Setup</h4>
            <Badge className="bg-watt-trust/20 text-watt-trust text-xs border-watt-trust/30">Configure</Badge>
          </div>
          
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div>
              <label className="block text-xs text-muted-foreground mb-1">Hashrate (TH/s)</label>
              <Input
                type="number"
                value={hashrate}
                onChange={(e) => setHashrate(e.target.value)}
                className="bg-muted border-border text-foreground text-sm focus:border-watt-trust/50 focus:ring-watt-trust/20"
                placeholder="200"
              />
            </div>
            
            <div>
              <label className="block text-xs text-muted-foreground mb-1">Energy ($/kWh)</label>
              <Input
                type="number"
                step="0.001"
                value={energyRate}
            ...
            <div>
              <label className="block text-xs text-muted-foreground mb-1">Power (W)</label>
              <Input
                type="number"
                value={powerDraw}
