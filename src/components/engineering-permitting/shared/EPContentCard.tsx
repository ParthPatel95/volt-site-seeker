...
export const EPContentCard: React.FC<EPContentCardProps> = ({
  children,
  className,
  theme = 'light',
  borderColor,
...
export const EPStatCard: React.FC<EPStatCardProps> = ({
  icon: Icon,
  value,
  label,
  sublabel,
...
interface EPMetricDisplayProps {
  metrics: Array<{
    label: string;
    value: string;
    change?: string;
...
export const EPMetricDisplay: React.FC<EPMetricDisplayProps> = ({ metrics, theme = 'light' }) => {
  const isDark = theme === 'dark';
