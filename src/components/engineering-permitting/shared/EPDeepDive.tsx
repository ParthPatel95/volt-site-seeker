...
export const EPDeepDive: React.FC<EPDeepDiveProps> = ({
  title,
  children,
  icon: Icon,
  theme = 'light',
...
export const EPStepByStep: React.FC<EPStepByStepProps> = ({ steps, theme = 'light' }) => {
  const isDark = theme === 'dark';
...
export const EPProcessFlow: React.FC<EPProcessFlowProps> = ({
  steps,
  connectorSymbol = '→',
  theme = 'light',
}) => {
