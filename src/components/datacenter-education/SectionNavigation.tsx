...
import { Zap, Wind, Cpu, Layout, ArrowUp, Globe, Gauge, Building2, Thermometer, Monitor, DollarSign } from 'lucide-react';
...
const SectionNavigation = () => {
  ...
  const sections = [
    { id: 'energy-source', icon: Globe, label: 'Energy' },
    { id: 'electrical', icon: Gauge, label: 'Electrical' },
    { id: 'facility-design', icon: Building2, label: 'Facility' },
    { id: 'airflow', icon: Thermometer, label: 'Airflow' },
    { id: 'cooling-systems', icon: Wind, label: 'Cooling' },
    { id: 'mining-hardware', icon: Cpu, label: 'Hardware' },
    { id: 'operations', icon: Monitor, label: 'Operations' },
  ...
  return (
    <>
      ...
      <nav className="fixed right-4 top-1/2 -translate-y-1/2 z-50 hidden lg:block">
        <div className="bg-card/90 backdrop-blur-sm rounded-full border border-border shadow-lg p-1.5">
