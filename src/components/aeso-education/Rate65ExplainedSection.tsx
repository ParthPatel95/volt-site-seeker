...
export const Rate65ExplainedSection = () => {
  ...
  return (
    <section className="py-12 md:py-16 bg-gradient-to-b from-watt-light to-white">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <ScrollReveal delay={0.1}>
          <Card className="mb-10 border-watt-navy/10 shadow-lg">
            <CardHeader className="bg-watt-navy text-white rounded-t-lg">
            ...
            <CardContent className="p-6">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h4 className="font-semibold text-watt-navy mb-3">Transmission vs Distribution Connected</h4>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 text-sm">
                      <span className="w-20 font-medium text-watt-navy">240 kV</span>
                      <div className="flex-1 h-3 bg-watt-bitcoin/20 rounded" />
                      <span className="text-watt-navy/60">Bulk Transmission</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm">
                      <span className="w-20 font-medium text-watt-navy">138 kV</span>
                      <div className="flex-1 h-3 bg-watt-bitcoin/40 rounded" />
                      <span className="text-watt-navy/60">Regional Transmission</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm">
                      <span className="w-20 font-medium text-watt-navy">69 kV</span>
                      <div className="flex-1 h-3 bg-watt-bitcoin/60 rounded" />
                      <span className="text-watt-navy/60">Sub-Transmission</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm">
                      <span className="w-20 font-medium text-watt-navy">25 kV</span>
                      <div className="flex-1 h-3 bg-watt-bitcoin/80 rounded" />
                      <span className="text-watt-navy/60">Rate 65 Minimum</span>
                    </div>
                  </div>
                </div>
                <div>
                  <h4 className="font-semibold text-watt-navy mb-3">Eligibility Requirements</h4>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                      <span className="text-watt-navy/70">
        ...
        <ScrollReveal delay={0.15}>
          <div className="mb-10">
            <h3 className="text-2xl font-bold text-watt-navy mb-6 text-center">Rate Comparison</h3>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-watt-navy text-white">
                ...
                <tbody>
                  {rateComparison.map((rate, idx) => (
                    <tr 
                      key={rate.rate}
                      className={`border-b border-watt-navy/10 ${
                        rate.highlight 
                    ...
                    >
                      <td className="p-4">
                        <span className={rate.highlight ? 'text-watt-bitcoin font-bold' : 'text-watt-navy'}>
                          {rate.rate}
                        </span>
                        {rate.highlight && (
                      ...
                      <td className="p-4 text-watt-navy/70">{rate.type}</td>
                      <td className="p-4">
                        <span className={rate.highlight ? 'text-green-600 font-bold' : 'text-watt-navy'}>
                          {rate.delivery}
                        </span>
                      </td>
                      <td className="p-4 text-watt-navy/70">{rate.minLoad}</td>
            ...
            <p className="text-xs text-watt-navy/50 mt-2 text-center">
        ...
        <ScrollReveal delay={0.2}>
          <div className="mb-10">
            <h3 className="text-2xl font-bold text-watt-navy mb-6 text-center">Key Benefits of Rate 65</h3>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {benefits.map((benefit, idx) => (
                <Card 
                  key={benefit.title}
                  className="border-watt-navy/10 hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
                >
                  <CardContent className="p-5">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h4 className="font-semibold text-watt-navy mb-1">{benefit.title}</h4>
                        <p className="text-sm text-watt-navy/70 mb-2">{benefit.description}</p>
            ...
            <CardContent className="p-6">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  <div>
                    <Label className="text-watt-navy font-medium mb-2 block">
                ...
                <div className="bg-watt-navy/5 rounded-xl p-6">
                  <h4 className="font-semibold text-watt-navy mb-4">Annual Cost Comparison</h4>
                  
                  <div className="space-y-4">
                    <div className="flex justify-between items-center pb-2 border-b border-watt-navy/10">
                      <span className="text-watt-navy/70">Annual Energy Consumption</span>
                      <span className="font-bold text-watt-navy">{(annualMWh / 1000).toFixed(0)} GWh</span>
                    </div>

                    <div className="flex justify-between items-center">
                      <span className="text-watt-navy/70">Rate 63 Delivery Cost</span>
                      <span className="text-red-600 font-medium">${(rate63Cost / 1000000).toFixed(1)}M/yr</span>
                    </div>

                    <div className="flex justify-between items-center">
                      <span className="text-watt-navy/70">Rate 65 Delivery Cost</span>
        ...
        <ScrollReveal delay={0.3}>
          <div className="mb-10">
            <h3 className="text-2xl font-bold text-watt-navy mb-6 text-center">Requirements & Process</h3>
            <Accordion type="single" collapsible className="space-y-2">
              {requirements.map((req, idx) => (
                <AccordionItem 
                  key={req.title} 
                  value={`item-${idx}`}
                  className="bg-white border border-watt-navy/10 rounded-lg px-4"
                >
                  <AccordionTrigger className="text-watt-navy font-medium hover:no-underline">
                  ...
                  <AccordionContent className="pb-4">
                    <ul className="space-y-2 pl-8">
                      {req.items.map((item, itemIdx) => (
                        <li key={itemIdx} className="flex items-start gap-2 text-watt-navy/70">
        ...
        <ScrollReveal delay={0.35}>
          <Card className="border-2 border-watt-bitcoin/30 bg-gradient-to-br from-watt-bitcoin/5 to-white shadow-xl">
            <CardContent className="p-6 md:p-8">
              <div className="flex flex-col md:flex-row items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <h3 className="text-2xl font-bold text-watt-navy mb-3">
                  ...
                  <div className="grid sm:grid-cols-3 gap-4">
                    <div className="bg-white rounded-lg p-3 border border-watt-navy/10">
                      <div className="text-2xl font-bold text-watt-bitcoin">$2-5</div>
                      <div className="text-xs text-watt-navy/60">/MWh Delivery (Rate 65)</div>
                    </div>
                    <div className="bg-white rounded-lg p-3 border border-watt-navy/10">
                      <div className="text-2xl font-bold text-green-600">85%</div>
                      <div className="text-xs text-watt-navy/60">Transmission Savings (12CP)</div>
                    </div>
                    <div className="bg-white rounded-lg p-3 border border-watt-navy/10">
                      <div className="text-2xl font-bold text-blue-600">$0</div>
                      <div className="text-xs text-watt-navy/60">Retailer Markup (Self-Retailer)</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-6 text-center">
          <Badge variant="outline" className="text-watt-navy/60 border-watt-navy/20">
            <FileText className="w-3 h-3 mr-1" />
