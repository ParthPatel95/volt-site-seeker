...
import { LayoutDashboard, Zap, Search, Shield, ChevronDown } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">Historical pricing, data exploration, ancillary services, and custom dashboards</p>
      </div>
