        ...
        <Card>
          ...
          <CollapsibleContent>
            <CardContent className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-0">
              ...
              <RateField label="Operating Reserve" unit="%" value={overrides.operatingReservePercent} defaultValue={AESO_RATE_DTS_2025.operatingReserve.ratePercent} badge="Verified" onChange={v => update('operatingReservePercent', v)} />
              <RateField label="TCR" unit="$/MWh" value={overrides.tcrMeteredEnergy} defaultValue={AESO_RATE_DTS_2025.tcr.meteredEnergy} badge="Verified" onChange={v => update('tcrMeteredEnergy', v)} />
