      ...
      <Card className="border-orange-200 bg-gradient-to-r from-orange-50 to-yellow-50">
        ...
        <CardContent>
          <div className="text-center py-8">
            ...
            <p className="mt-4 text-muted-foreground">Fetching live Bitcoin network data...</p>
          </div>
        </CardContent>
      </Card>
    );
    ...
    <Card className="border-orange-200 bg-gradient-to-r from-orange-50 to-yellow-50">
      ...
      <CardContent>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-4">
          <div className="text-center p-3 sm:p-4 bg-card rounded-lg shadow-sm min-w-0 overflow-hidden flex flex-col justify-center">
            ...
            <div className="text-xs sm:text-sm text-muted-foreground">BTC Price</div>
          </div>
          ...
          <div className="text-center p-3 sm:p-4 bg-card rounded-lg shadow-sm min-w-0 overflow-hidden flex flex-col justify-center">
            ...
            <div className="text-xs sm:text-sm text-muted-foreground">Network Hashrate</div>
          </div>
          ...
          <div className="text-center p-3 sm:p-4 bg-card rounded-lg shadow-sm min-w-0 overflow-hidden flex flex-col justify-center">
            ...
            <div className="text-xs sm:text-sm text-muted-foreground">Block Reward</div>
          </div>
          ...
          <div className="text-center p-3 sm:p-4 bg-card rounded-lg shadow-sm min-w-0 overflow-hidden flex flex-col justify-center">
            ...
            <div className="text-xs sm:text-sm text-muted-foreground">Avg Block Time</div>
          </div>
          ...
          <div className="text-center p-3 sm:p-4 bg-card rounded-lg shadow-sm min-w-0 overflow-hidden flex flex-col justify-center">
            ...
            <div className="text-xs sm:text-sm text-muted-foreground">Days to Halving</div>
          </div>
        </div>
      </CardContent>
    </Card>
