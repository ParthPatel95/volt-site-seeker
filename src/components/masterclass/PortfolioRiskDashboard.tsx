    ...
    <div className="bg-card border border-border rounded-2xl p-6 shadow-lg">
                ...
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    <div className={cn(
                      ...
                      site.operationalStatus === "development" ? "bg-yellow-500" : "bg-muted-foreground"
                    )} />
        ...
        <div>
          ...
          <ResponsiveContainer width="100%" height={250}>
            <BarChart data={aggregateRiskData} layout="vertical">
              <XAxis type="number" domain={[0, 100]} tick={{ fontSize: 12, fill: 'hsl(var(--foreground))' }} />
          ...
          {selectedSiteData ? (
            <ResponsiveContainer width="100%" height={250}>
              <RadarChart data={getRadarData(selectedSiteData)}>
                ...
                <PolarRadiusAxis angle={30} domain={[0, 100]} tick={{ fontSize: 10, fill: 'hsl(var(--foreground))' }} />
                <Radar
      ...
      {showAddSite && (
        ...
        >
          ...
          >
            <h3 className="text-lg font-bold text-foreground mb-4">Add New Site</h3>
            <div className="space-y-4">
              ...
              <div>
                <Label className="text-foreground">Capacity (MW)</Label>
                <Input 
                  type="number"
