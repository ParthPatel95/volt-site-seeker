          ...
          {!isExpanded && (
            <div className="p-3 space-y-2">
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isCurrentTrack ? `bg-gradient-to-r ${track.color} text-white` : "bg-muted text-muted-foreground hover:bg-muted/80"
                    )}
                  >
              ...
              <div className="pt-2 border-t border-border">
                <div className="w-10 h-10 rounded-lg bg-gradient-to-r from-purple-500/20 to-green-500/20 flex items-center justify-center">
                          ...
                          {track.sections.map((section) => {
                            ...
                            return (
                              <button
                                ...
                                className="flex items-center gap-2 w-full text-left p-1.5 rounded hover:bg-muted/50 transition-colors"
                              >
                                <button
                                  onClick={(e) => {
                                    e.stopPropagation();
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 lg:hidden">
        <div className="bg-card/95 backdrop-blur border-t border-border">
          ...
          >
            <div className="flex items-center gap-3">
              {currentTrackData && (
                <div className={cn(
                  ...
                  `bg-gradient-to-r ${currentTrackData.color}`
                )}>
            ...
            {showMobileMenu ? <ChevronDown className="w-5 h-5" /> : <ChevronUp className="w-5 h-5" />}
          </button>
