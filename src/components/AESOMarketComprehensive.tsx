    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50/30 p-4 sm:p-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
        <div className="min-w-0 flex-1">
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-foreground flex items-center flex-wrap">
            ...
            <span className="break-words">AESO Market & Intelligence Hub</span>
          </h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <Card className="bg-gradient-to-br from-orange-500 to-orange-600 text-white border-0">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-orange-100 truncate">Market Stress</CardTitle>
            <Brain className="h-4 w-4 text-orange-200 flex-shrink-0" />
          </CardHeader>
          <CardContent>
            <div className="text-lg sm:text-xl lg:text-2xl font-bold">
              {getMarketStressValue()}
            </div>
            <p className="text-xs text-orange-200 break-words">
      ...
      <Tabs defaultValue="market" className="space-y-4">
        <div className="w-full overflow-x-auto">
          <TabsList className="grid grid-cols-2 lg:grid-cols-7 w-full min-w-max sm:min-w-0">
            <TabsTrigger value="market" className="flex items-center space-x-1 sm:space-x-2 text-xs sm:text-sm px-2 sm:px-4">
              <Zap className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0" />
              <span className="hidden sm:inline">Market Data</span>
              <span className="sm:hidden">Market</span>
            </TabsTrigger>
            <TabsTrigger value="generation" className="flex items-center space-x-1 sm:space-x-2 text-xs sm:text-sm px-2 sm:px-4">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    <span className="text-sm text-muted-foreground">Supplemental Reserve</span>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className={`font-semibold ${interchangeData.alberta_british_columbia > 0 ? 'text-green-600' : 'text-red-600'}`}>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className={`font-semibold ${interchangeData.alberta_saskatchewan > 0 ? 'text-green-600' : 'text-red-600'}`}>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className={`font-semibold ${interchangeData.alberta_montana > 0 ? 'text-green-600' : 'text-red-600'}`}>
                  ...
                  <div className="border-t pt-2">
                    <div className="flex justify-between">
                      ...
                      <span className={`font-bold ${interchangeData.total_net_interchange > 0 ? 'text-green-600' : 'text-red-600'}`}>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-green-600">{energyStorageData.charging_mw} MW</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-muted-foreground">Discharging</span>
                    <span className="font-semibold text-blue-600">{energyStorageData.discharging_mw} MW</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-muted-foreground">Net Storage</span>
                    <span className={`font-semibold ${energyStorageData.net_storage_mw > 0 ? 'text-green-600' : 'text-red-600'}`}>
                  ...
                  <div className="border-t pt-2">
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold">{energyStorageData.state_of_charge_percent}%</span>
                    </div>
                  </div>
                </div>
              </CardContent>
