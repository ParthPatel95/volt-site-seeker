...
const RedundancyArchitecturesSection = () => {
  ...
  return (
    <section id="redundancy" className="py-16 md:py-24 bg-muted">
            ...
            <CardContent>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                {redundancyConfigs.map((config) => (
                  <div key={config.name} className="p-4 bg-card rounded-lg border border-border">
                    ...
                    <div className="space-y-2 text-xs">
                      <div className="flex justify-between">
                        <span className="text-muted-foreground/50">Availability:</span>
                        <span className="font-bold text-foreground">{config.availability}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground/50">Downtime:</span>
                        <span className="text-muted-foreground">{config.downtime}</span>
                      </div>
                      <div className="pt-2 border-t border-border">
                        <span className="text-watt-bitcoin font-medium">Best for: </span>
                        <span className="text-muted-foreground">{config.use}</span>
                      </div>
                    </div>
                  </div>
                ))}
          ...
          <Card className="mb-12 border-border shadow-institutional">
            ...
            <CardContent>
                ...
                <div className="space-y-3">
                  <div className="p-4 bg-muted rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-semibold text-foreground">Tier I - Basic</span>
                    </div>
                  ...
                  <div className="p-4 bg-muted rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-semibold text-foreground">Tier II - Redundant Components</span>
                    </div>
                    <p className="text-xs text-muted-foreground">
                ...
                <div className="space-y-3">
                  <div className="p-4 bg-muted rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-semibold text-foreground">Tier III - Concurrently Maintainable</span>
                    </div>
                    <p className="text-xs text-muted-foreground">
                  ...
                  <div className="p-4 bg-watt-bitcoin/5 rounded-lg border border-watt-bitcoin/20">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-semibold text-foreground">Tier IV - Fault Tolerant</span>
                    </div>
                    <p className="text-xs text-muted-foreground">
              ...
              <div className="mt-6 p-4 bg-muted/50 rounded-lg">
                <h5 className="font-semibold text-foreground mb-2">Mining Facility Reality</h5>
                <p className="text-sm text-muted-foreground">
                  ...
                  miner failures are acceptable. Focus on <strong className="text-foreground">concurrent maintainability</strong> 
            ...
            <Card className="h-full border-border shadow-institutional">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="p-3 bg-muted rounded-lg">
                  <h5 className="font-medium text-foreground text-sm mb-1">Hybrid Approach:</h5>
                  <p className="text-xs text-muted-foreground">
          ...
          <ScrollReveal delay={400}>
            <Card className="h-full border-border shadow-institutional">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="p-3 bg-muted rounded-lg">
                    <h5 className="font-medium text-foreground text-sm">Diesel Generators</h5>
                    <p className="text-xs text-muted-foreground">
                  ...
                  <div className="p-3 bg-muted rounded-lg">
                    <h5 className="font-medium text-foreground text-sm">Natural Gas Generators</h5>
                    <p className="text-xs text-muted-foreground">
                  ...
                  <div className="p-3 bg-muted rounded-lg">
                    <h5 className="font-medium text-foreground text-sm">Sizing for Mining</h5>
                    <p className="text-xs text-muted-foreground">
                ...
                <div className="p-3 bg-watt-bitcoin/10 rounded-lg border border-watt-bitcoin/20">
                  <h5 className="font-semibold text-foreground text-sm mb-1">Economics Calculation:</h5>
                  <p className="text-xs text-muted-foreground">
            ...
            <CardContent>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="p-3 bg-muted rounded-lg">
                      <h5 className="font-medium text-foreground">Open Transition</h5>
                      <p className="text-xs text-muted-foreground">
                    ...
                    <div className="p-3 bg-muted rounded-lg">
                      <h5 className="font-medium text-foreground">Closed Transition</h5>
                      <p className="text-xs text-muted-foreground">
                    ...
                    <div className="p-3 bg-muted rounded-lg">
                      <h5 className="font-medium text-foreground">Soft Load Transfer</h5>
                      <p className="text-xs text-muted-foreground">
                ...
                <div className="space-y-4">
                  <h4 className="font-semibold text-foreground">ATS Specifications:</h4>
                  
                  <div className="space-y-2">
                    <div className="p-3 bg-muted rounded-lg flex justify-between">
                      <span className="text-sm text-foreground">Transfer time (open)</span>
                      <span className="font-bold text-foreground">100-500 ms</span>
                    </div>
                    <div className="p-3 bg-muted rounded-lg flex justify-between">
                      <span className="text-sm text-foreground">Transfer time (closed)</span>
                      <span className="font-bold text-foreground">&lt;100 ms</span>
                    </div>
                    <div className="p-3 bg-muted rounded-lg flex justify-between">
                      <span className="text-sm text-foreground">Typical sizes</span>
                      <span className="font-bold text-foreground">100A - 4000A</span>
                    </div>
                    <div className="p-3 bg-muted rounded-lg flex justify-between">
                      <span className="text-sm text-foreground">Withstand rating</span>
                      <span className="font-bold text-foreground">65-100 kA</span>
                    </div>
                  </div>

                  <div className="p-3 bg-watt-success/10 rounded-lg border border-watt-success/20">
                    <h5 className="font-semibold text-foreground text-sm mb-1">Static Transfer Switch (STS)</h5>
                    <p className="text-xs text-muted-foreground">
