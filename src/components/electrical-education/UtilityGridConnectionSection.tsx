...
const UtilityGridConnectionSection = () => {
  ...
  return (
    <section id="grid-connection" className="py-16 md:py-24 bg-muted">
            ...
            <Card className="h-full border-border shadow-institutional">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground text-sm">
                  In Alberta, the <strong className="text-foreground">AESO (Alberta Electric System Operator)</strong> manages the wholesale 
                ...
                <div className="space-y-3">
                  <h4 className="font-semibold text-foreground">Key AESO Requirements:</h4>
                  <ul className="text-sm text-muted-foreground space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-watt-bitcoin mt-2 flex-shrink-0" />
                      <span><strong className="text-foreground">System Access Service Request (SASR):</strong> Formal application to AESO for new or modified connection</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-watt-bitcoin mt-2 flex-shrink-0" />
                      <span><strong className="text-foreground">Transmission Facility Owner (TFO):</strong> Work with local TFO (AltaLink, ATCO) for physical connection</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-watt-bitcoin mt-2 flex-shrink-0" />
                      <span><strong className="text-foreground">Technical Requirements:</strong> Meet AESO reliability standards for protection, metering, and operations</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-watt-bitcoin mt-2 flex-shrink-0" />
                      <span><strong className="text-foreground">Pool Participant:</strong> Register as market participant to purchase energy from pool</span>
                    </li>
                  </ul>
                </div>

                <div className="p-3 bg-watt-success/10 rounded-lg border border-watt-success/20">
                  <h5 className="font-semibold text-foreground text-sm mb-1">Alberta Advantage</h5>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="p-3 bg-muted rounded-lg">
                    <div className="flex justify-between items-center mb-1">
                      <span className="text-sm text-foreground">Study Costs</span>
                      <span className="font-semibold text-foreground">$50K - $200K</span>
                    </div>
                    <p className="text-xs text-muted-foreground">System impact + facility studies (non-refundable)</p>
                  </div>
                  
                  <div className="p-3 bg-muted rounded-lg">
                    <div className="flex justify-between items-center mb-1">
                      <span className="text-sm text-foreground">Substation (customer-owned)</span>
                      <span className="font-semibold text-foreground">$2M - $10M</span>
                    </div>
                    <p className="text-xs text-muted-foreground">Depends on voltage level and redundancy requirements</p>
                  </div>
                  
                  <div className="p-3 bg-muted rounded-lg">
                    <div className="flex justify-between items-center mb-1">
                      <span className="text-sm text-foreground">Line Extension</span>
                      <span className="font-semibold text-foreground">$500K - $2M/mile</span>
                    </div>
                    <p className="text-xs text-muted-foreground">If site is distant from existing transmission</p>
                  </div>
                  
                  <div className="p-3 bg-muted rounded-lg">
                    <div className="flex justify-between items-center mb-1">
                      <span className="text-sm text-foreground">Network Upgrades</span>
                      <span className="font-semibold text-foreground">$0 - $20M+</span>
                    </div>
                    <p className="text-xs text-muted-foreground">If grid needs reinforcement (often refundable)</p>
                  </div>
                </div>
                ...
                <div className="p-3 bg-watt-bitcoin/10 rounded-lg border border-watt-bitcoin/20">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      <strong className="text-foreground">Cost Tip:</strong> Sites with existing substation capacity nearby can save 
            ...
            <CardContent>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <h4 className="font-semibold text-foreground">Revenue-Grade Metering</h4>
                  ...
                  <div className="space-y-2">
                    <div className="p-3 bg-muted rounded-lg">
                      <h5 className="font-medium text-foreground text-sm">Current Transformers (CTs)</h5>
                      <p className="text-xs text-muted-foreground">
                    ...
                    <div className="p-3 bg-muted rounded-lg">
                      <h5 className="font-medium text-foreground text-sm">Potential Transformers (PTs)</h5>
                      <p className="text-xs text-muted-foreground">
                    ...
                    <div className="p-3 bg-muted rounded-lg">
                      <h5 className="font-medium text-foreground text-sm">Smart Meters</h5>
                      <p className="text-xs text-muted-foreground">
                ...
                <div className="space-y-4">
                  <h4 className="font-semibold text-foreground">Utility Bill Components</h4>
                  <p className="text-sm text-muted-foreground">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between p-3 bg-muted rounded-lg">
                      <span className="text-sm text-foreground">Energy Charge</span>
                      <span className="text-sm font-medium text-foreground">$/MWh consumed</span>
                    </div>
                    <div className="flex justify-between p-3 bg-muted rounded-lg">
                      <span className="text-sm text-foreground">Demand Charge</span>
                      <span className="text-sm font-medium text-foreground">$/kW peak demand</span>
                    </div>
                    <div className="flex justify-between p-3 bg-muted rounded-lg">
                      <span className="text-sm text-foreground">Transmission Tariff</span>
                      <span className="text-sm font-medium text-foreground">$/kW (12CP in Alberta)</span>
                    </div>
                    <div className="flex justify-between p-3 bg-muted rounded-lg">
                      <span className="text-sm text-foreground">Distribution Charge</span>
                      <span className="text-sm font-medium text-foreground">$/kW or $/kWh</span>
                    </div>
                    <div className="flex justify-between p-3 bg-muted rounded-lg">
                      <span className="text-sm text-foreground">Power Factor Penalty</span>
                      <span className="text-sm font-medium text-foreground">If PF &lt; 0.90</span>
                    </div>
                  </div>

                  <div className="p-3 bg-watt-success/10 rounded-lg border border-watt-success/20">
                    <h5 className="font-semibold text-foreground text-sm mb-1">12CP Optimization</h5>
                    <p className="text-xs text-muted-foreground">
