...
const MediumVoltageSwitchgearSection = () => {
  ...
  return (
    <section id="switchgear" className="py-16 md:py-24 bg-white">
            ...
            <CardContent>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="p-4 bg-watt-light rounded-lg">
                  <h4 className="font-semibold text-watt-navy mb-2">Metal-Enclosed</h4>
                  ...
                  <div className="text-xs text-watt-navy/60 space-y-1">
                ...
                <div className="p-4 bg-watt-bitcoin/5 rounded-lg border border-watt-bitcoin/20">
                  <h4 className="font-semibold text-watt-navy mb-2">Metal-Clad</h4>
                  <p className="text-sm text-watt-navy/70 mb-3">
                ...
                <div className="p-4 bg-watt-light rounded-lg">
                  <h4 className="font-semibold text-watt-navy mb-2">Pad-Mounted</h4>
                  <p className="text-sm text-watt-navy/70 mb-3">
                ...
                {breakerTypes.map((breaker) => (
                  <div key={breaker.type} className="p-4 bg-watt-light rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      <h4 className="font-semibold text-watt-navy">{breaker.type} Breaker</h4>
                      <span className="px-2 py-0.5 bg-watt-bitcoin/10 text-watt-bitcoin text-xs rounded">
                        {breaker.voltage}
                      </span>
                    </div>
                    <p className="text-sm text-watt-navy/70 mb-3">{breaker.description}</p>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="p-3 bg-watt-light rounded-lg">
                    <h5 className="font-medium text-watt-navy">Single Bus</h5>
                    ...
                    <div className="mt-2 p-2 bg-white rounded flex items-center justify-center gap-2">
                      <div className="w-full h-1 bg-watt-bitcoin rounded" />
                    </div>
                  </div>

                  <div className="p-3 bg-watt-light rounded-lg">
                    <h5 className="font-medium text-watt-navy">Double Bus</h5>
                    <p className="text-xs text-watt-navy/60">
                      Two buses with bus-tie breaker. Circuits can be switched between buses. 
                      One bus can be maintained while other serves load.
                    </p>
                    <div className="mt-2 p-2 bg-white rounded flex flex-col items-center gap-2">
                      <div className="w-full h-1 bg-watt-bitcoin rounded" />
                  ...
                  <div className="p-3 bg-watt-light rounded-lg">
                    <h5 className="font-medium text-watt-navy">Ring Bus</h5>
                    <p className="text-xs text-watt-navy/60">
                    ...
                    <div className="mt-2 p-2 bg-white rounded flex items-center justify-center">
                  ...
                  <div className="p-3 bg-watt-bitcoin/5 rounded-lg border border-watt-bitcoin/20">
                    <h5 className="font-medium text-watt-navy">Breaker-and-a-Half</h5>
                    <p className="text-xs text-watt-navy/60">
          ...
          <ScrollReveal delay={400}>
            <Card className="h-full border-watt-navy/10 shadow-institutional">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  <h4 className="font-semibold text-watt-navy">IEEE C37.20.7 Accessibility Types:</h4>
                  
                  <div className="p-3 bg-watt-light rounded-lg">
                    <div className="flex items-center gap-2 mb-1">
                      <span className="px-2 py-0.5 bg-watt-bitcoin text-white text-xs font-bold rounded">Type 1</span>
                      <span className="font-medium text-watt-navy text-sm">Front Only</span>
                    </div>
                    <p className="text-xs text-watt-navy/60">
                  ...
                  <div className="p-3 bg-watt-light rounded-lg">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="font-medium text-watt-navy text-sm">Front and Rear</span>
                    </div>
                    <p className="text-xs text-watt-navy/60">
                  ...
                  <div className="p-3 bg-watt-success/10 rounded-lg border border-watt-success/20">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="font-medium text-watt-navy text-sm">Front, Rear, and Sides</span>
                    </div>
                    <p className="text-xs text-watt-navy/60">
                ...
                <div className="p-3 bg-watt-bitcoin/10 rounded-lg border border-watt-bitcoin/20">
                  <h5 className="font-semibold text-watt-navy text-sm mb-1">Arc Venting</h5>
            ...
            <CardContent>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                {protectionRelays.map((relay) => (
                  <div key={relay.code} className="p-3 bg-watt-light rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="w-8 h-8 flex items-center justify-center bg-watt-bitcoin text-white text-sm font-bold rounded">
                        {relay.code}
                      </span>
                      <span className="font-medium text-watt-navy text-sm">{relay.name}</span>
                    </div>
                    <p className="text-xs text-watt-navy/60">{relay.description}</p>
                  </div>
                ))}
              </div>

              <div className="mt-6 p-4 bg-watt-navy/5 rounded-lg">
                <h5 className="font-semibold text-watt-navy mb-2">Coordination Study</h5>
                <p className="text-sm text-watt-navy/70">
                  A <strong>protection coordination study</strong> ensures that during a fault, only the breaker 
