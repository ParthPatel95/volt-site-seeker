...
export function PJMMarketDashboard() {
  const { 
    pricing, 
    loadData, 
    generationMix,
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              PJM Interconnection - Real-Time Market Data
            </p>
          </div>
          <Button 
            onClick={() => refetch()}
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Badge variant={currentPrice > 80 ? 'destructive' : 'default'} className="mt-2">
                  {currentPrice > 80 ? 'HIGH DEMAND' : 'NORMAL'}
                </Badge>
              </div>
              <div>
