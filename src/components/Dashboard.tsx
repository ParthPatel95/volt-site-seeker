            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                ...
                <div className="p-3 bg-watt-accent/10 rounded-xl group-hover:bg-watt-accent/20 transition-colors">
                  <BarChart3 className="w-6 h-6 text-watt-accent" />
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-6 p-6">
              ...
              {misoPricing && (
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="bg-muted/50 p-3 rounded-lg">
                    <p className="text-sm font-medium text-muted-foreground">Peak</p>
                    <p className="text-lg font-bold text-red-600">${misoPricing.peak_price.toFixed(2)}</p>
                  </div>
                </div>
              )}
              ...
              {misoGeneration && (
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div className="flex items-center gap-2">
                      <Sun className="w-4 h-4 text-yellow-500" />
                      <span>Solar: {((misoGeneration.solar_mw / misoGeneration.total_generation_mw) * 100).toFixed(0)}%</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Battery className="w-4 h-4 text-purple-500" />
          ...
          <CardContent className="p-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center p-6 bg-gradient-to-br from-watt-success/10 to-watt-success/5 rounded-xl border border-watt-success/20">
                ...
                <p className="text-sm text-muted-foreground mt-1">Avg Renewable Mix</p>
              </div>
            </div>
          </CardContent>
        </Card>
