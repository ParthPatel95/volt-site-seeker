...
export const SiteLayoutSection = () => {
  return (
    <section id="site-layout" className="py-16 md:py-24 bg-muted">
        ...
        <ScrollReveal>
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full mb-4">
              ...
              <span className="text-sm font-medium text-primary">Site Planning</span>
            </div>
        ...
        <ScrollReveal delay={400}>
          <Card className="bg-card border-border shadow-lg">
            <CardContent className="p-6 md:p-8">
              <h3 className="text-xl font-bold text-foreground mb-6">Alberta Heartland 45MW Site Layout</h3>
              
              <div className="relative bg-gradient-to-br from-green-100 to-green-50 dark:from-green-900/20 dark:to-green-800/10 rounded-xl p-8 min-h-[400px]">
                {/* Compass */}
                ...
                <div className="absolute bottom-4 left-4 flex items-center gap-2">
                  <div className="w-20 h-1 bg-foreground/30" />
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                  <div className="grid grid-cols-6 gap-1">
                    {Array.from({ length: 30 }).map((_, i) => (
                      <div
                        key={i}
                        className="w-6 h-10 bg-secondary/60 rounded-sm border border-secondary"
                        title={`Container ${i + 1}`}
                      />
                    ))}
                  </div>
                  <p className="text-center text-xs text-muted-foreground mt-2">30 Hydro Containers</p>
                </div>
                ...
                <div className="absolute bottom-16 left-1/2 -translate-x-1/2">
                  ...
                  <p className="text-center text-xs text-muted-foreground mt-1">Substation</p>
                </div>
                ...
                <div className="absolute top-8 left-1/2 -translate-x-1/2">
                  ...
                  <p className="text-center text-xs text-muted-foreground mt-1">Cooling Towers</p>
                </div>

                {/* Buffer Zone (South) */}
                <div className="absolute bottom-4 left-1/4 right-1/4 h-8 bg-green-600/30 rounded flex items-center justify-center">
                  <span className="text-xs text-green-800 dark:text-green-300">🌲 Buffer Zone 🌲</span>
                </div>
                ...
                <div className="absolute top-1/2 right-4 -translate-y-1/2 text-center">
                  ...
                  <p className="text-xs font-bold text-market-positive">1.7km →</p>
                </div>

                {/* Noise Direction Arrows */}
                <div className="absolute top-1/3 left-[60%] text-primary/50 text-sm">
                  ↗ Low noise
                </div>
              </div>
              ...
              <div className="mt-6 grid md:grid-cols-3 gap-4">
                ...
                <div className="p-4 bg-muted rounded-lg text-center">
                  <p className="text-2xl font-bold text-secondary">North</p>
                  <p className="text-sm text-muted-foreground">Cooling Orientation</p>
                </div>
                <div className="p-4 bg-muted rounded-lg text-center">
                  <p className="text-2xl font-bold text-market-positive">1.7km</p>
                  <p className="text-sm text-muted-foreground">Receptor Distance</p>
                </div>
              </div>
            </CardContent>
          </Card>
