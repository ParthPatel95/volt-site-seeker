...
interface TISectionWrapperProps {
...
export const TISectionWrapper: React.FC<TISectionWrapperProps> = ({
  children,
  id,
  theme = 'light',
  className,
  ...
  const themeClasses = {
    ...
    accent: 'bg-gradient-to-br from-[hsl(var(--watt-purple)/0.05)] via-background to-[hsl(var(--watt-bitcoin)/0.05)]',
  };
...
export default TISectionWrapper;
