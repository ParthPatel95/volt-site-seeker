...
export const TIKeyInsight: React.FC<TIKeyInsightProps> = ({
  title,
  children,
  type = 'insight',
  icon,
...
interface TIInlineInsightProps {
  children: React.ReactNode;
  theme?: 'light' | 'dark';
}

export const TIInlineInsight: React.FC<TIInlineInsightProps> = ({ children, theme = 'light' }) => {
  const isDark = theme === 'dark';
