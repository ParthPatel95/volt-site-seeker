...
export function SPPMarketDashboard() {
  const { 
    pricing, 
    loadData, 
    generationMix,
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Southwest Power Pool - Real-Time Market Data
            </p>
          </div>
          <Button 
            onClick={() => refetch()}
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Badge variant={currentPrice > 70 ? 'destructive' : 'default'} className="mt-2">
                  {currentPrice > 70 ? 'HIGH DEMAND' : 'NORMAL'}
                </Badge>
              </div>
              <div>
