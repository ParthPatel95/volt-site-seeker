...
export const VoltMarketDashboard: React.FC = () => {
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-muted flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-xl font-semibold text-foreground mb-4">Please sign in to access your dashboard</h2>
    ...
    return (
      <div className="min-h-screen bg-muted flex items-center justify-center">
        <div className="max-w-md mx-auto text-center">
          <AlertTriangle className="w-16 h-16 text-data-warning mx-auto mb-4" />
          ...
          <div className="text-sm text-muted-foreground">
            Or go to{' '}
            <Link to="/voltmarket/profile" className="text-primary hover:underline">
              Profile Settings
            </Link>
          </div>
        </div>
