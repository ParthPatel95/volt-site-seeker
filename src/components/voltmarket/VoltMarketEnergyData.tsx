...
export const VoltMarketEnergyData = () => {
  ...
  return (
    <Card className="group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 cursor-pointer bg-gradient-to-br from-card to-primary/5 border-0 shadow-lg min-h-[800px] flex flex-col">
      ...
      <CardHeader className="relative pb-4">
        ...
        <p className="text-sm text-muted-foreground">Live AESO & ERCOT market intelligence</p>
      </CardHeader>
      ...
      <CardContent className="relative space-y-6 flex-1">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="text-sm font-semibold text-foreground">Alberta (AESO)</h4>
        ...
        <div className="space-y-4 pt-4 border-t border-border">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="text-sm font-semibold text-foreground">Texas (ERCOT)</h4>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className={`bg-gradient-to-br from-indigo-50 to-indigo-100/50 rounded-lg p-3 transition-all duration-500 border border-indigo-200 ${isAnimating ? 'scale-105 bg-indigo-100/70' : ''}`}>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <span className="text-xs text-muted-foreground">Peak Forecast</span>
              </div>
        ...
        <div className="space-y-3 pt-4 border-t border-border">
          <div className="flex items-center gap-2 mb-3">
            <h4 className="text-sm font-semibold text-foreground">Alberta Generation Sources</h4>
            <Badge className="bg-red-100 text-red-700 text-xs">Real-time</Badge>
          </div>
          <div className="grid grid-cols-2 gap-2">
            <div className="bg-green-50 rounded-lg p-2 border border-green-200">
              <div className="text-xs text-muted-foreground mb-1">Natural Gas</div>
              <div className="text-sm font-bold text-green-700">
                {aesoGeneration?.natural_gas_mw || '4,567'} MW
              </div>
            </div>
            <div className="bg-blue-50 rounded-lg p-2 border border-blue-200">
              <div className="text-xs text-muted-foreground mb-1">Wind Power</div>
              <div className="text-sm font-bold text-blue-700">
                {aesoGeneration?.wind_mw || '3,245'} MW
              </div>
            </div>
            <div className="bg-cyan-50 rounded-lg p-2 border border-cyan-200">
              <div className="text-xs text-muted-foreground mb-1">Hydro</div>
        ...
        <div className="space-y-3 pt-4 border-t border-border">
          <h4 className="text-sm font-semibold text-foreground">Market Analysis</h4>
          <div className="space-y-3">
            {/* Price Trends */}
            <div className="bg-gradient-to-br from-watt-primary/5 to-watt-primary/10 rounded-lg p-3 border border-watt-primary/20">
              <div className="text-xs text-muted-foreground mb-2">24H Price Change</div>
              <div className="flex justify-between items-center">
                <span className="text-sm font-medium text-foreground">Alberta</span>
                <span className="text-sm font-bold text-data-positive">+$2.45 (+5.7%)</span>
              </div>
              <div className="flex justify-between items-center mt-1">
                <span className="text-sm font-medium text-foreground">Texas</span>
                <span className="text-sm font-bold text-destructive">-$1.32 (-3.3%)</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="bg-gradient-to-br from-green-50 to-green-100/50 rounded-lg p-2 border border-green-200">
                <div className="text-xs text-muted-foreground mb-1">AESO Status</div>
              ...
              <div className="bg-gradient-to-br from-orange-50 to-orange-100/50 rounded-lg p-2 border border-orange-200">
                <div className="text-xs text-muted-foreground mb-1">ERCOT Status</div>
            ...
            <div className="bg-gradient-to-br from-watt-accent/5 to-watt-accent/10 rounded-lg p-3 border border-watt-accent/20">
              <div className="text-xs text-muted-foreground mb-2">Peak vs Off-Peak (ERCOT)</div>
              <div className="flex justify-between items-center">
                <span className="text-sm font-medium text-foreground">Peak Price</span>
                <span className="text-sm font-bold text-watt-accent">
                  ${ercotPricing?.peak_price?.toFixed(2) || '52.30'}/MWh
                </span>
              </div>
              <div className="flex justify-between items-center mt-1">
                <span className="text-sm font-medium text-foreground">Off-Peak Price</span>
                <span className="text-sm font-bold text-watt-accent">
