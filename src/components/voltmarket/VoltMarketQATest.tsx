  ...
  return (
    <div className="min-h-screen bg-muted py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">VoltMarket QA Testing</h1>
          <p className="text-muted-foreground">Comprehensive testing of all VoltMarket features</p>
        </div>
